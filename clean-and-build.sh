...
echo "=========================================="
echo ""
echo "Standalone app: build/MatildaPiano_artefacts/Release/Matilda Piano 2.app"
echo "AU plugin:      ~/Library/Audio/Plug-Ins/Components/Matilda Piano 2.component"
echo ""
echo "To open the app:"
echo "  open build/MatildaPiano_artefacts/Release/Matilda\\ Piano\\ 2.app"
echo ""
