...
echo "=========================================="
echo ""
echo "Standalone app: build/MatildaPiano_artefacts/Release/Matilda Piano 3.app"
echo "AU plugin:      ~/Library/Audio/Plug-Ins/Components/Matilda Piano 3.component"
echo "VST3 plugin:    ~/Library/Audio/Plug-Ins/VST3/Matilda Piano 3.vst3"
echo ""
echo "To open the app:"
echo "  open build/MatildaPiano_artefacts/Release/Matilda\\ Piano\\ 3.app"
echo ""
