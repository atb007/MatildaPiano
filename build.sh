...
echo ""
echo "Build complete! Plugins installed to:"
echo "  AU:   ~/Library/Audio/Plug-Ins/Components/Matilda Piano 3.component"
echo "  VST3: ~/Library/Audio/Plug-Ins/VST3/Matilda Piano 3.vst3"
echo ""
echo "To test in GarageBand (AU):"
echo "  1. Open GarageBand"
echo "  2. Create a Software Instrument track"
echo "  3. Select 'Matilda Piano 3' from the Audio Units list"
echo ""
echo "To test in a VST3 host (e.g. Reaper, Ableton):"
echo "  Rescan plugins, then choose 'Matilda Piano 3' under Matilda Audio"
